...
<!--grupo de listas-->
                            <div class="list-group  ms-1 me-2">
                                <a class="list-group-item list-group-action bg-light" aria-current="true" href="admin.php">Nuevo Producto</a>
                            </div>
                            <div class="list-group mt-1 ms-1 me-2">
                                <a class="list-group-item list-group-action bg-dark border-dark text-white active" aria-current="true" href="almacen.php">Almacen</a>
                            </div>
...
<!--find el aside-->
<!--consulta para traer los productos del 1 al 4-->
            <?php
                $consulta="SELECT * FROM productos INNER JOIN almacen WHERE productos.id = almacen.id_producto ORDER BY productos.id DESC";
                $resultado=mysqli_query($conn,$consulta);
            ?>
<!--fin de la consulta-->
<!--contenedor-->
...
<!--primer row-->
                <div class="row">
                    <h1 class="text-center text-capitalize">Productos en el almacen</h1>
<!--primer foreach-->
                    <?php 
                        foreach($resultado as $opciones) :
                    ?>
<!--columna del primer row-->
                    <div class="col-md-3">
                        <div class="card">
                            <div class="card-img">
                            ...
                            <div class="card-body">
                                <a class="text-dark text-decoration-none text-capitalize" href="editar_producto.php ?id=<?php echo $opciones['id']?>"><h5 class="card-title"><?php echo $opciones['nombre']?></h5></a>
                                <p class="card-text"><?php echo $opciones['informacion']?></p>
