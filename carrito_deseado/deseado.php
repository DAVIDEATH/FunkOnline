...
<?php
                        if(isset($_SESSION['correo']) AND isset($login)){
                            ...
                            if(mysqli_num_rows($resultado)>0){
                                ...
                                ?>
                                    <l1 class="nav-item"><a class="nav-link text-capitalize active" href="deseado.php">
                                    ...
                                    <l1 class="nav-item"><a class="nav-link text-capitalize " href="carrito.php">
...
<!--consulta para traer datos-->
    <?php
        $id_usuario = $_SESSION['id'];
        $consulta = "SELECT * FROM deseado INNER JOIN productos WHERE deseado.usuario = $id_usuario and productos.id = deseado.id_producto ORDER BY deseado.id DESC";
        $resultado = mysqli_query($conn, $consulta);
        ...
        ?>
        <h1 class="bg-danger pb-2 fw-bolder text-white text-center">No tienes articulos en Deseado</h1>
        <?php
        }
    ?>
<!--fin de la consulta-->
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text text-capitalize"><?php echo $result['informacion']?></p>
                            ...
                            <div class="row">
                                <a class="btn btn bg-danger fw-bolder mt-2 text-white" href="eliminar_deseado.php ?id=<?php echo $result['id']?>">Eliminar</a>
                            </div>
                    </div>
                </div>
            </div>
